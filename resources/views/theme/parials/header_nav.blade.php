            ...
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item submenu dropdown @yield('category-active')">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item "><a class="nav-link" href="{{ route("theme.single_blog") }}">Food</a></li>
                  <li class="nav-item "><a class="nav-link" href="{{ route("theme.single_blog") }}">Bussiness</a></li>
                  <li class="nav-item "><a class="nav-link" href="{{ route("theme.single_blog") }}">Travel</a></li>
                </ul>
              </li>
